-- Fix A: Update notify_assignment_completion function to skip notifications for participants without auth users
...
DROP TRIGGER IF EXISTS notify_assignment_completion ON events;
CREATE TRIGGER notify_assignment_completion
  AFTER UPDATE ON events
  FOR EACH ROW
  EXECUTE FUNCTION notify_assignment_completion();